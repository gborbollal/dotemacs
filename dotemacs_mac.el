...
(custom-set-variables
 ...
 '(package-selected-packages
	 '(backward-forward helm-fuzzy-find helm-ag helm-projectile projectile use-package go-mode json-mode neotree yaml-mode helm-lsp helm flycheck lsp-ui dap-mode company))
 '(savehist-mode t)
 '(tab-width 2)
 '(visible-bell t))
(custom-set-faces
